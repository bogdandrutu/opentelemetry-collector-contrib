...
func TestSpan_Matching_False(t *testing.T) {
	...
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
			...
			tCtx := ottlspan.BorrowContext(span, library, resource, ptrace.NewScopeSpans(), ptrace.NewResourceSpans())
			defer ottlspan.ReturnContext(tCtx)
...
func TestSpan_MissingServiceName(t *testing.T) {
	...
	tCtx := ottlspan.BorrowContext(emptySpan, pcommon.NewInstrumentationScope(), pcommon.NewResource(), ptrace.NewScopeSpans(), ptrace.NewResourceSpans())
	defer ottlspan.ReturnContext(tCtx)
...
func Test_NewSkipExpr_With_Bridge(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			tCtx := ottlspan.BorrowContext(span, scope, resource, ptrace.NewScopeSpans(), ptrace.NewResourceSpans())
			defer ottlspan.ReturnContext(tCtx)
